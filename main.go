...
func getConfig() map[string][]string {
	...
	conf.addGroup("executable", []string{"apk", "bat", "com", "exe", "gadget", "jar", "pka", "wsf"})
	...
	conf.addGroup("presentation", []string{"drawio", "key", "odp", "pps", "ppt", "pptx"})
	conf.addGroup("system", []string{"bak", "cab", "cfg", "conf", "cpl", "cur", "dll", "dmp", "drv", "icns", "ini", "lnk", "msi", "sh", "sys", "tmp"})
	conf.addGroup("text_files", []string{"doc", "pages", "docx", "md", "odt ", "pdf", "rtf", "tex", "txt", "wks ", "wpd", "wps"})
